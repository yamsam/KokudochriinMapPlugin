...
#ifndef QPLACEMANAGERENGINEKokudo_H
#define QPLACEMANAGERENGINEKokudo_H
...
class QNetworkReply;
class QPlaceCategoriesReplyKokudo;

class QPlaceManagerEngineKokudo : public QPlaceManagerEngine
{
    Q_OBJECT

public:
    QPlaceManagerEngineKokudo(const QVariantMap &parameters, QGeoServiceProvider::Error *error,
                           QString *errorString);
    ~QPlaceManagerEngineKokudo();
...
private:
    ...
    QList<QPlaceCategoriesReplyKokudo *> m_pendingCategoriesReply;
...
#endif // QPLACEMANAGERENGINEKokudo_H
