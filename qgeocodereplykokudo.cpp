...
QGeoCodeReplyKokudo::QGeoCodeReplyKokudo(QNetworkReply *reply, QObject *parent)
...
QGeoCodeReplyKokudo::~QGeoCodeReplyKokudo()
{
    if (m_reply)
        m_reply->deleteLater();
}

void QGeoCodeReplyKokudo::abort()
{
    if (!m_reply)
        return;
...
void QGeoCodeReplyKokudo::networkReplyFinished()
{
    if (!m_reply)
        return;
...
void QGeoCodeReplyKokudo::networkReplyError(QNetworkReply::NetworkError error)
{
    Q_UNUSED(error)
