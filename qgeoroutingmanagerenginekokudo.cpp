...
QGeoRoutingManagerEngineKokudo::QGeoRoutingManagerEngineKokudo(const QVariantMap &parameters,
...
QGeoRoutingManagerEngineKokudo::~QGeoRoutingManagerEngineKokudo()
{
}

QGeoRouteReply* QGeoRoutingManagerEngineKokudo::calculateRoute(const QGeoRouteRequest &request)
{
    ...
    QGeoRouteReplyKokudo *routeReply = new QGeoRouteReplyKokudo(reply, request, this);
...
void QGeoRoutingManagerEngineKokudo::replyFinished()
{
...
void QGeoRoutingManagerEngineKokudo::replyError(QGeoRouteReply::Error errorCode,
