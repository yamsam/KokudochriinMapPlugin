...
QGeoCodingManagerEngineKokudo::QGeoCodingManagerEngineKokudo(const QVariantMap &parameters,
...
:   QGeoCodingManagerEngine(parameters), m_networkManager(new QNetworkAccessManager(this))
{
    ...
    if (parameters.contains(QStringLiteral("Kokudo.geocoding.host")))
...
QGeoCodingManagerEngineKokudo::~QGeoCodingManagerEngineKokudo()
{
}

QGeoCodeReply *QGeoCodingManagerEngineKokudo::geocode(const QGeoAddress &address, const QGeoShape &bounds)
{
...
void QGeoCodingManagerEngineKokudo::replyFinished()
{
...
void QGeoCodingManagerEngineKokudo::replyError(QGeoCodeReply::Error errorCode, const QString &errorString)
{
    QGeoCodeReply *reply = qobject_cast<QGeoCodeReply *>(sender());
    if (reply)
