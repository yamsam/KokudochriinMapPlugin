...
QPlaceSearchReplyKokudo::QPlaceSearchReplyKokudo(const QPlaceSearchRequest &request,
                                             QNetworkReply *reply, QPlaceManagerEngineKokudo *parent)
...
QPlaceSearchReplyKokudo::~QPlaceSearchReplyKokudo()
{
}

void QPlaceSearchReplyKokudo::abort()
{
    if (m_reply)
        m_reply->abort();
}

void QPlaceSearchReplyKokudo::setError(QPlaceReply::Error errorCode, const QString &errorString)
{
...
void QPlaceSearchReplyKokudo::replyFinished()
{
...
QPlaceResult QPlaceSearchReplyKokudo::parsePlaceResult(const QJsonObject &item) const
{
    QPlace place;
