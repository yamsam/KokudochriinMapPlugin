...
#ifndef QGEOCODINGMANAGERENGINEKokudo_H
#define QGEOCODINGMANAGERENGINEKokudo_H
...
class QGeoCodingManagerEngineKokudo : public QGeoCodingManagerEngine
{
    Q_OBJECT

public:
    QGeoCodingManagerEngineKokudo(const QVariantMap &parameters, QGeoServiceProvider::Error *error,
                               QString *errorString);
    ~QGeoCodingManagerEngineKokudo();
...
#endif // QGEOCODINGMANAGERENGINEKokudo_H
